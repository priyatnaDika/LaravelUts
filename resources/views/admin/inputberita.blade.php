                            ...
                            <div class="col-span-3 sm:col-span-2">
                                ...
                                <div class="mt-1 flex rounded-md shadow-sm">
                                    <input type="text" name="title"
                                        ...
                                        placeholder="Judul Berita max 255">
                                </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <textarea name="description" rows="3"
                                    class=" @error('description') border-red-500 @enderror shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border-gray-300 rounded-md"
                                    placeholder="Text isian berita"> {{(isset($berita))?$berita->description:old('description')}} </textarea>
                            </div>
